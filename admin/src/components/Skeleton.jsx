...
export default function Skeleton({ width = '100%', height = 16, style = {}, borderRadius = 6 }) {
  return (
    <div className="admin-component-skeleton" id="admin-component-skeleton" style={{ display: 'contents' }}>
...
export function ProductCardSkeleton() {
  return (
    <div className="admin-component-product-card-skeleton" id="admin-component-product-card-skeleton" style={{ border: '1px solid #eee', borderRadius: 12, overflow: 'hidden' }}>
...
export function PageSkeleton() {
  return (
    <div className="admin-component-page-skeleton" id="admin-component-page-skeleton" style={{ padding: '32px 20px', maxWidth: 900, margin: '0 auto' }}>
