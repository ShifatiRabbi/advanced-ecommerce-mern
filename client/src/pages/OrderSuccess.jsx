      ...
      <div style={s.card}>
        <div style={s.iconWrap}>
          <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
            ...
            <path d="M14 24l7 7 13-13" stroke="#276749" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
        ...
        <div style={s.infoBox}>
          ...
          <div style={s.infoRow}>
            ...
            <span style={{ ...s.value, fontSize: 20, fontWeight: 700 }}>৳{order?.total?.toLocaleString()}</span>
          </div>
          <div style={s.infoRow}>
